...
///
/// The [CalendarTabBarViewer] widget allows you to create a beautiful and functional calendar
...
class CalendarTabBarViewer extends StatelessWidget {
  /// Creates a [CalendarTabBarViewer].
  ///
