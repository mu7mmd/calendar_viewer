...
///
/// The [CalendarListViewer] widget allows you to create a beautiful and functional calendar
...
class CalendarListViewer extends StatelessWidget {
  /// Creates a [CalendarListViewer].
  ///
  ...
  const CalendarListViewer({
    super.key,
    this.eachMonthHeight = 420,
    this.eachMonthWidth,
  ...
  /// The width of the week bar and dates section in the calendar.
  final double? eachMonthWidth;

  /// A [ScrollController] for controlling month tabs. Optional; if provided, its length must be 12.
  final ScrollController? scrollController;

  /// The scroll direction of the list view.
  ...
  /// The padding to be applied to the list view.
